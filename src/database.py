...
class VectorDB():
    ...
    def add_documents(self, vector_store):
        vector_store.add_documents(self.documents, ids=[doc.metadata["id"] for doc in self.documents])

    def similarity_search(self, query, vector_store):
